...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Verarbeitung'), ['action' => 'edit', $verarbeitung->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Verarbeitung'), ['action' => 'delete', $verarbeitung->id], ['confirm' => __('Are you sure you want to delete # {0}?', $verarbeitung->id)]) ?> </li>
...
<div class="verarbeitung view large-9 medium-8 columns content">
    <h3><?= h($verarbeitung->name) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($verarbeitung->materialverwendung)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($verarbeitung->materialverwendung as $materialverwendung): ?>
            <tr>
